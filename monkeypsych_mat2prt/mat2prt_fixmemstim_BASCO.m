function prt_fname = mat2prt_fixmemstim(mat_file, run_name)
...
prtpreds(10).offset = sort([states_onset_reward_fix(states_reward_fix == 50); states_onset_reward_mem(states_reward_mem == 50)] + reward_time); % to end of ITI
