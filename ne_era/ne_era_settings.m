...
switch era_settings_id
    ...
    case 'Human_reach_decision'
        ...
        % statistics
        settings.assignment = []; % vector that assigns conditions to factor levels. If left emtpy [], ANOVA will be skipped
        settings.varnames = {}; % factor names for ANOVA
        settings.levnames = {}; % factor level names for ANOVA
        settings.conditions2take = [1:8];
        settings.condition_numbers = [1 3 5 2 4 6 7 8]; % numbering of conditions in barplot coming from AVG file is different from numbering coming from post-hoc comparisons (multcompare function),
