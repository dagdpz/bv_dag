...
switch session_settings_id
	...
	case 'Human_reach_decision'
		...
		settings.mdm.mask = 'Y:\MRI\Human\mni_icbm152_t1_tal_nlin_sym_09a_mask_vtc.msk'; %Y:\Sources\NeuroElf_v11_7521\_files\masks\colin_brain_ICBMnorm_brain3mm.msk'; %'Y:\MRI\Human\colin_brain_ICBMnorm_TAL.msk'; 
	...
	case 'Curius_microstim_20130814-20131009'
        ...
        elseif ispc
            settings.mdm.mask = 'Y:\MRI\Curius\mask.msk';
        end	
    ...
    case 'Curius_microstim_BASCO_20131129-now'
...
% 		% see Leys et al. (2013). Detecting outliers: Do not use standard deviation around the mean, use absolute deviation around the median. Journal of Experimental Social Psychology, 49(4), 764�766.
		...
		% settings for converting behavioral files to BV *.prt
		settings.prt.beh2prt_function_handle = @mat2prt_fixmemstim_BASCO;%@mat2prt_fixmemstim; %mat2prt_ind; % @mat2prt_es_analysis
		settings.model = ''; % name of the model; if left empty (''), name of settings.prt.beh2prt_function_handle will be used
	...
	case 'Curius_fixmemory_baseline_20131129-now'
        ...
        case 'Curius_fixmemory_baseline_BASCO_20131129-now'
		...
		% settings for converting behavioral files to BV *.prt
		settings.prt.beh2prt_function_handle = @mat2prt_fixmem_BASCO;
		settings.model = '';
...
% 		settings.fmr_quality.avg_exclude_before_after_outlier = [100 100]; % ms, time to exclude from avg before / after outlier
    ...
    case 'Bacchus_microstim_BASCO_20170201-now'
...
% 		settings.fmr_quality.avg_exclude_before_after_outlier = [100 100]; % ms, time to exclude from avg before / after outlier
		...
		% settings for converting behavioral files to BV *.prt
		settings.prt.beh2prt_function_handle = @BA_mat2prt_fixmemstim_BASCO;%@mat2prt_fixmemstim; %mat2prt_ind; % @mat2prt_es_analysis
		settings.model = ''; % name of the model; if left empty (''), name of settings.prt.beh2prt_function_handle will be used
