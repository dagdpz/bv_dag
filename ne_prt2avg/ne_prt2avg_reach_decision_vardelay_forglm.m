...
%% SETTINGS
avg_name = [mfilename '_cue']; % or something else
...
conditions2take = {'sac_choi_l_cue','sac_choi_r_cue','sac_instr_l_cue','sac_instr_r_cue',...
...
avg.PreInterval		= 13;
avg.PostInterval	= 18;
avg.NrOfTimePoints	= 1 + avg.PreInterval + avg.PostInterval;
avg.BaselineMode	= 3;
