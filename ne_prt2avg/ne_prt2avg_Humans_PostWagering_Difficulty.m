...
conditions2take = {'Diff1' ,'Diff2' ,'Diff3' ,'Diff4' ,'Diff5'}; %,...
%     'unsucc_Diff1', 'unsucc_Diff2', 'unsucc_Diff3', 'unsucc_Diff4', 'unsucc_Diff5', ...
%     'postcontrol', ...
%     'postwager1','postwager2', 'postwager3' ,'postwager4', 'postwager5', 'postwager6'};


avg.ProtocolTimeResolution = 'msec';
avg.ResolutionOfDataPoints = 'Seconds';
avg.NrOfTimePoints	= 30;
avg.PreInterval		= 5;
avg.PostInterval	= 24;
avg.BaselineMode	= 3;
...
for c = 1:length(conditions2take),
	...
	avg.Curve(c).EventDuration = round(mean(EventDuration));
end
