...
conditions2take = {'sac_choi_l_9_cue','sac_choi_r_9_cue','sac_instr_l_9_cue','sac_instr_r_9_cue',...
...
avg.NrOfTimePoints	= 22;
avg.PreInterval		= 11.8;
avg.PostInterval	= 11; % cue + delay + longest possible Tar_acq + hold = 0.2 + 9 + 0.8 + 1 = 11
avg.BaselineMode	= 3;
