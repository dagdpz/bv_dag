...
conditions2take = {'sac_choi_l_15_cue','sac_choi_r_15_cue','sac_instr_l_15_cue','sac_instr_r_15_cue',...
...
avg.NrOfTimePoints	= 28;
avg.PreInterval		= 11.8;
avg.PostInterval	= 17; % cue + delay + longest possible Tar_acq + hold = 0.2 + 15 + 0.8 + 1 = 17
avg.BaselineMode	= 3;
