...
conditions2take = {'sac_choi_l_6_cue','sac_choi_r_6_cue','sac_instr_l_6_cue','sac_instr_r_6_cue',...
...
avg.NrOfTimePoints	= 19;
avg.PreInterval		= 11.8;
avg.PostInterval	= 8; % cue + delay + longest possible Tar_acq + hold = 0.2 + 6 + 0.8 + 1 = 8
avg.BaselineMode	= 3;
