...
conditions2take = {'sac_choi_l_12_cue','sac_choi_r_12_cue','sac_instr_l_12_cue','sac_instr_r_12_cue',...
...
avg.NrOfTimePoints	= 25;
avg.PreInterval		= 11.8;
avg.PostInterval	= 14; % cue + delay + longest possible Tar_acq + hold = 0.2 + 12 + 0.8 + 1 = 14
avg.BaselineMode	= 3;
