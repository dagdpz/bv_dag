...
conditions2take = {'sac_choi_l_3_cue','sac_choi_r_3_cue','sac_instr_l_3_cue','sac_instr_r_3_cue',...
...
avg.NrOfTimePoints	= 16;
avg.PreInterval		= 11.8;
avg.PostInterval	= 5; % cue + delay + longest possible Tar_acq + hold = 0.2 + 3 + 0.8 + 1 = 5
avg.BaselineMode	= 3;
